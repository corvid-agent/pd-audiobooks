...
import { PlayerBarComponent } from './shared/components/player-bar.component';
...
const ONBOARDING_KEY = 'pd-audiobooks-onboarded';

@Component({
  selector: 'app-root',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [RouterOutlet, HeaderComponent, FooterComponent, ToastContainerComponent, BottomNavComponent, PlayerBarComponent],
  template: `
    ...
    @if (showOnboarding) {
      <div class="onboarding-overlay" role="dialog" aria-label="Welcome">
        <div class="onboarding-panel">
          <h2 class="onboarding-title">Welcome to PD Audiobooks</h2>
          <p class="onboarding-text">Your library of free public domain audiobooks from LibriVox. Here's what you can do:</p>
          <ul class="onboarding-list">
            <li><strong>Browse</strong> &mdash; Search thousands of free audiobooks by title, author, or genre</li>
            <li><strong>Listen</strong> &mdash; Stream any audiobook chapter directly in your browser</li>
            <li><strong>Collect</strong> &mdash; Bookmark favorites and track your listening progress</li>
          ...
          <button class="btn-primary onboarding-btn" (click)="dismissOnboarding()">Start Listening</button>
        </div>
      </div>
    }
